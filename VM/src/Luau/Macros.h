// Macros.h - Common macros for Luau
#pragma once

// Fast flag system stubs
#define LUAU_FASTFLAGVARIABLE(name, value) namespace FFlag { bool name = value; }
...
#define LUAU_FALLTHROUGH __attribute__((fallthrough))
#else
